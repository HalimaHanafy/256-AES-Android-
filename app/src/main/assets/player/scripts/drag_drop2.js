...
$(function() { 
    ...
    for(var x=0; x<data.length; x++){
        var z=x+1;
        $('.draggable_container').append('<div style="animation-delay:1s" class="draggable_item animated bounceIn">'+data[myArray[x]].answer+'</div>');
        $('section').append('<div style="animation-delay:0.'+z+'s" class="animated slideInRight col-md-12 col-sm-12 col-xs-12 quiz_content"><div class="col-md-3 col-sm-3 col-xs-3 droppable_container"><div style="animation-delay:1s" class="droppable_item animated bounceIn"></div></div><div class="col-md-9 col-sm-9 col-xs-9 quiz_text">'+data[x].quiz+'</div></div>');
    } 
