...
$(function(){
    ...
    for(var x=0; x<cards.length; x++){
        ...
        cards_arr.push('<div class="card effect__click animated zoomIn" keyWord="'+x+'"><div class="card__front"><img src="../../theme/images/flip_card.png"></div><div class="card__back"><p>'+cards[x].img+'<p></div></div>');
    }
    shuffle(cards_arr);
